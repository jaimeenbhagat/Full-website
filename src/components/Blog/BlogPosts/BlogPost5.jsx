...
const links = {
  ...
  IL1: "/blog/workplace-wellness-strategies",
  IL2: "/services/team-building",
  IL3: "/contact"
};
...
const BlogPost5 = () => (
  <div className="fixed inset-0 z-[9999] min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#111] to-[#0a0a0a] overflow-y-auto">
    ...
    <motion.div className="relative w-full h-[60vh] md:h-[70vh] overflow-hidden mt-0"
      ...
      <img src={about} alt="Building Resilient Teams: The Power of Emotional Intelligence in the Workplace" className="w-full h-full object-cover" />
      ...
      <motion.div className="absolute bottom-8 left-8 right-20 md:left-12 md:right-24"
        ...
        <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight drop-shadow-2xl">
          Building Resilient Teams: The Power of Emotional Intelligence in the Workplace
        </h1>
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-8 lg:px-12 py-12">
        ...
        <motion.article className="prose prose-invert prose-lg max-w-none"
          ...
          <p className="text-[#E0E0E0] text-xl leading-relaxed mb-8">
            In today's rapidly evolving workplace, emotional intelligence has emerged as a cornerstone of effective team building and organizational success. 
            This comprehensive guide explores how fostering emotional intelligence can transform workplace dynamics and create more resilient, connected teams.
            <a href={links.EL1} target="_blank" rel="noopener noreferrer">(EL1)</a>
          </p>

          <h2 className="text-[#00FFAB] text-3xl font-bold mb-6 mt-12">Understanding Emotional Intelligence in Teams</h2>
          <p className="text-[#E0E0E0] leading-relaxed mb-6">
            Emotional intelligence encompasses the ability to recognize, understand, and manage emotions effectively, both individually and within team dynamics. 
            Teams with high emotional intelligence demonstrate better communication, conflict resolution, and collaborative problem-solving capabilities.
            <a href={links.EL2} target="_blank" rel="noopener noreferrer">(EL2)</a>
          </p>

          <h2 className="text-[#00FFAB] text-3xl font-bold mb-6 mt-12">Key Strategies for Building Emotional Intelligence</h2>
          <ol className="text-[#E0E0E0] space-y-4 mb-8">
            <li>
              <strong>Active Listening Practices:</strong> Encourage team members to practice deep listening, focusing on understanding rather than responding.
              <a href={links.EL3} target="_blank" rel="noopener noreferrer">(EL3)</a>
            </li>
            <li>
              <strong>Emotion Recognition Training:</strong> Implement workshops that help team members identify and articulate their emotional states and triggers.
              <a href={links.EL4} target="_blank" rel="noopener noreferrer">(EL4)</a>
            </li>
            <li>
              <strong>Empathy Building Exercises:</strong> Create opportunities for team members to understand different perspectives through role-playing and scenario discussions.
              <a href={links.EL5} target="_blank" rel="noopener noreferrer">(EL5)</a>
            </li>
          </ol>

          <p className="text-[#E0E0E0] leading-relaxed mb-8">
            For organizations looking to implement comprehensive emotional intelligence programs, consider exploring our 
            <a href={links.IL1} className="text-[#00FFAB] hover:text-[#00CC88]"> workplace wellness strategies</a> and 
            <a href={links.IL2} className="text-[#00FFAB] hover:text-[#00CC88]"> team building services</a>.
          </p>

          <div className="bg-gradient-to-r from-[#00FFAB]/10 via-[#00CC88]/5 to-[#00FFAB]/10 rounded-lg p-8 mt-12 border border-[#00FFAB]/20">
            <h3 className="text-[#00FFAB] text-2xl font-bold mb-4">Ready to Transform Your Team?</h3>
            <p className="text-[#E0E0E0] mb-6">
              Discover how OneThrive can help your organization build emotionally intelligent, resilient teams that drive innovation and success.
            </p>
