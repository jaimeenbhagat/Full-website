              ...
              <div key={name}>
                {dropdown ? (
                  <div>
                    <button
                      onClick={() => handleDropdownToggle(name)}
                      className="text-white text-center text-base font-semibold hover:text-[#00FFAB] tracking-wide uppercase transition flex items-center justify-center gap-2 w-full"
                    >
                      {name}
                      <HiChevronDown className={`transform transition-transform duration-200 ${dropdownOpen === name ? 'rotate-180' : ''}`} />
                    </button>
                  ...
                  <button
                    onClick={() => handleNavClick(path)}
                    className="text-white text-center text-base font-semibold hover:text-[#00FFAB] tracking-wide uppercase transition w-full"
                  >
                    {name}
                  </button>
                )}
